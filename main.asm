...
output_display macro wd,xxx
	...
	first_loop: ;this loop is responsible for getting the digits
		...
		add dl,48
		mov ah,0
		push dx ;push the digits of the result
				;on the stack to be printed
				;dx is the digit of the result
				;ah is the quotient of the division
				;bl is the divisor
				;ax is the dividend
				;cl is the counter
	...
	secund_loop: ;this loop is responsible for displaying the result
		pop dx   ;dx is the digit of the result of the operation
			     ;pop dx is necessary because the digits are
			     ;stored in the stack
